...
/// @nodoc
mixin _$Client {
  String get id => throw _privateConstructorUsedError; // required ClientId id,
...
abstract class $ClientCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, DateTime creationTime});
}
...
class _$_Client implements _Client {
  const _$_Client(
      {required this.id, required this.name, required this.creationTime});
...
// required ClientId id,
  ...
  @override
  String toString() {
    return 'Client(id: $id, name: $name, creationTime: $creationTime)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, creationTime);
...
abstract class _Client implements Client {
  const factory _Client(
      ...
      required final DateTime creationTime}) = _$_Client;

  @override
  String get id;
  @override // required ClientId id,
  String get name;
  @override
